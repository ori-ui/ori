...
pub fn keysym_to_key(keysym: Keysym) -> Key {
    match keysym {
        ...
        Keysym::SUN_Copy | Keysym::OSF_Copy | Keysym::XF86_Copy | Keysym::_3270_Copy => Key::Copy,
        Keysym::SUN_Cut | Keysym::OSF_Cut | Keysym::XF86_Cut => Key::Cut,
        ...
        Keysym::_3270_Play => Key::Play,
        Keysym::Select => Key::Select,
        Keysym::SUN_Print_Screen | Keysym::_3270_PrintScreen => Key::PrintScreen,
